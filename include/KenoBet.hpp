...
class KenoBet {
    public:
        //! @brief Cria uma aposta Keno vazia.
        KenoBet( ) : saldo_jogador(0)
        { /* vazio */ };

        /*! @brief Adiciona um número a aposta apenas se o número ainda não estiver lá.
        ...
        /*! @brief Define a quantidade de dinheiro que o jogador está apostando.
        ...
        /*! @brief Recupera o salário do jogador nesta aposta.
            @return The wage value. */
        tipo_dinheiro get_saldo( void ) const;

        /*! @brief Retorna ao número atual de apostas do jogador.
            @return Número de pontos presentes na aposta. */
        size_t qtd_apostas( void ) const;

        /*! @brief Determine quantos pontos correspondem aos acertos passados ​​como argumento.
        ...
        /*! @brief Return a vector< spot_type > com os pontos que o jogador escolheu até agora.
